<?php
   ...
   if($checkrows>0)
   {
        ...
        echo"</script>";
        include_once 'bzaddemployee.php';
   }
   ...
   else
   {
    ...
    //insert results from the form input
      ...
      $params = array($_POST["social"], $_POST["fname"], $_POST["lname"],$_POST["rank"], $_POST["depnum"], $_POST["location"], $_POST["hours"],(float)$_POST["salary"], $_POST["activity"], $program, $otrate);	
