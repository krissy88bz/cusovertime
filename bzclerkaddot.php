...
table.tftable td {
  ...
  <!--overtime info -->
            <div class="addottestbox" >
                     ...
                     <form class="searchbox"  method="post" action="bzclerkaddot.php">
                  ...
                  echo "
                     <table id='t01'>
                      <tr>
                            ...
                            <input action='select.php' type='submit' value='Select' name='select'/>
                      ...
                      <tr>
                       ...
                       <td><input type='text' name='lname' id='myPass' value='$row[2]' disabled='disabled' /></td>
                        ...
                        <tr><td>DATE-TIME FROM (yyyy-mm-dd):</td><td>
                        <input type='datetime' name='datetimefrom' value='2017-02-01 5:00pm' required/>
                        <td></td></tr>
                           
                        <tr><td>DATE-TIME TO (yyyy-mm-dd):</td><td>
                        <input type='datetime' name='datetimeto' value='2017-02-01 10:00pm'  required/></td></tr>
