...
<html>
                        ...
                        <div class="user-section">
                           ...
                           // $location = "";
                            ...
                            if(!empty($_POST["search"]["post_at"])) {	
                                ...
                                $sql="SELECT * FROM login WHERE email='$find' ";
                                    ...
                                    $queryCondition = "WHERE timefrom BETWEEN '$fiy-$fim-$fid' AND '" . $post_at_todate . "' AND location ='$location' ";
                                   // $queryCondition2 = "WHERE location LIKE '$location'";
                            }



                            $sql = "SELECT * from bz " . $queryCondition . " ORDER BY name, timefrom asc";
    ...
    <!--search -->
            <div class="searchemployeetestbox" >
                     ...
                     <div id="gradient"></div>         
                      <?php  
                      echo "&nbsp; &nbsp; &nbsp; Today's Date: ". date("Y/m/d"). "&nbsp;&nbsp; Time: ".date("h:i a"); ?>
            
                                    <h2 style="margin-left:30px">Search Over-Time Records By Date</h2>
                                    <form name="frmSearch" method="POST" enctype=”multipart/form-data” action="bzclerkcreatereport.php">
                                ...
                                <input type="submit" value="Print Report" formaction = "bzreport_vie mw.php" name="print" style="height:30px; width:110px; "/><p></p>
