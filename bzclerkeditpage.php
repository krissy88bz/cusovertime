               ...
               // Fetch one and one row
                  ...
                  echo "
                      ...
                      <tr>
                            ...
                            <input action='bzclerkupdate.php' type='submit' value='Save Update' name='update'/>
                      ...
                      <tr>
                       ...
                       <th> Location:</th>
                        <td><input type='text' name='location' id='myPass' value='$row[4]' disabled='disabled />
                           </td>
                       </tr>
                      <th> Role:</th>
                        <td>
