...
table#t01 th {
                ...
                <ul class="nav" id="side-menu">
                   ...
                   <li class="sidebar-search">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="bzclerkaddemployee.php">Add New</a>
                            </li>
                            <li>
                                <a href="bzclerksearchemployee.php">View Employee Profile</a>
                            </li>
                    ...
                    <li>
                         <a href="bzcreatereportclerk.php"><i class="fa fa-files-o fa-fw"></i>Create Report<span></span></a>
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <i class="fa fa-folder-open"></i><b>
                            ...
                            View, Edit or Delete Employee Profile from OverTime System
  ...
  <!--search -->
            <div class="searchemployeetestbox" >
                     ...
                     <form class="searchbox"  method="post" action="clerksearchemployee.php">
                  ...
                  echo "
                     <table id='t01'>
                      <tr>
                            ...
                            <input action='deleteemployee.php' type='submit' value='Delete' name='delete'/>
                            <input action='clerkeditemployee.php' type='submit' value='Edit' name='edit'/>
                      ...
                      <tr>
                       ...
                       <tr>
                        <th>Rank:</th>
                        <td><input type='text' name='rank' id='myPass' value='$row[3]' disabled='disabled' /></td>
                       </tr>
                        <tr>
                       <th> Department No.:</th>
                        <td><input type='text' name='depnum' id='myPass' value='$row[4]' disabled='disabled' /></td>
                       </tr>
                        <tr>
                      <th> Location:</th>
                        <td><input type='text' name='location' id='myPass' value='$row[5]' disabled='disabled' /></td>
                       </tr>
                       <tr>
                      <th> Employee Hours:</th>
                        <td><input type='text' name='hours' id='myPass' value='$row[6]' disabled='disabled' /></td>
                       </tr>
                       <tr>
                      <th> Salary:</th>
                        <td><input type='text' name='salary' id='myPass' value='$row[7]' disabled='disabled' /></td>
                       </tr>
                       <tr>
                      <th> Activity Program:</th>
                        <td><input type='text' name='activity' id='myPass' value='$row[8]' disabled='disabled' /></td>
                       </tr>
                       <tr>
                       <tr>
                      <th> Program:</th>
                        <td><input type='text' name='program' id='myPass' value='$row[9]' disabled='disabled' /></td>
                       </tr>
