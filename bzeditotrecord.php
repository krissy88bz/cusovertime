                  ...
                  echo "
                     ...
                     <table id='t01'>
                      <tr>
                            ...
                            <form action='bzsaveeditot.php' method='POST'>
                            ...
                            <input type='submit' name='bzsaveeditot' value='Update'  action='bzsaveeditot.php' />
                            <input action='bzverifyot.php'type='submit' name='verifyot' value='Verify' />
