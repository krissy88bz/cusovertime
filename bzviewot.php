...
table#t01 th {
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <i class="fa fa-folder-open"></i><b>
                            ...
                            View, Edit or Delete Employee OverTime Record from OverTime System
  ...
  <!--search -->
            <div class="searchemployeetestbox" >
                     ...
                     <form class="searchbox"  method="post" action="bzviewot.php">
                  ...
                  echo "
                     <table id='t01'>
                      <tr>
                            ...
                            <input action='bzselectotrecord.php' type='submit' value='Select' name='select'/>
