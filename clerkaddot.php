...
table.tftable td {
  ...
  <!--overtime info -->
            <div class="addottestbox" >
                     ...
                     <form class="searchbox"  method="post" action="clerkaddot.php">
                     ...
                     <table id='t01'>
                      ...
                      <tr>
                       ...
                       <td><input type='text' name='lname' id='myPass' value='$row[2]' disabled='disabled' /></td>
                        ...
                        <input type='datetime' name='datetimeto' value='2017-01-01 5:00pm'  required/></td></tr>
