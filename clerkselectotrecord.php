<?php
            ...
            include 'deleteotrecord.php'; 
            include 'clerkeditotrecord.php';
           ...
           if( $conn === false ) 
              ...
              $select_id = $_POST['social'];
               ...
               $sql="SELECT * FROM cz WHERE social = '$select_id'";
               ...
               // Fetch one and one row
                ...
                <tr>
                  <td> 
                       ...
                       <input action='deleteotrecord.php' type='submit' value='Delete' name='delete' style='height:20px;width:60px'/> 
                       <input action='editotrecord.php' type='submit' value='Edit' name='edit'  style='height:20px;width:60px'/></td>  
                  <td width='13%'>". $date." </td>
                  <td>".$timefrom."</td>
                  <td>".$timeto."</td>    
                  <td>$row[7]</td>
