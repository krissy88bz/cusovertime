...
if(isset($_SESSION['id'])){
   echo $_SESSION['id'];
	...
	$sql = "SELECT * from cz " . $queryCondition . " ORDER BY name asc";
    ...
    <!--search -->
              <div class="searchemployeetestbox" >
                     ...
                     <div id="gradient"></div>         
                                    ...
                                    <form name="frmSearch" method="POST" enctype=”multipart/form-data” action="createreportclerk.php">
                                ...
                                <input type="submit" value="Print Report" formaction = "report_view.php" name="print" style="height:30px; width:110px; "/><p></p>
